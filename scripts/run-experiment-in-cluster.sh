...
# ssh $CLUSTER_HOST "OAR_JOB_ID=$JOB_ID oarsh $MACHINE_NAME 'rm -rf asd-project1/analysis/experiments'"
...
rsync -avz --exclude 'OAR.*' --exclude '.*' $CLUSTER_HOST:./asd-project1/analysis/experiments/ ./analysis/experiments/