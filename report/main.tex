...
\subsection{Latency}
We measure latency in hops, because the network in these experiments are uniform. This means every pair of nodes have an equal latency value for every other pair (experiments were executed by processes one machine). 
