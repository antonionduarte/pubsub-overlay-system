...
\subsection{Latency}
Figures \ref{fig:latency-1024} and \ref{fig:latency-65536} show the publish latency of the protocols under different configurations. Plumtree has a higher latency because .... GossipSub has the lowest latency since it floods the network with message but this has tradeoffs as it also increases network usage.
